...
describe("CheckoutRepository test", () => {
  ...
  it("should find a order", async () => {
    ...
    await OrderModel.create({
      id: "1",
      client: new ClientCheckoutModel({
        id: "1",
        name: "client name",
        email: "test@domain.com",
        document: "0000000",
      ...
      products: [
        new ProductCheckoutModel({ id: "1", name: "first product", description: "first product description", salesPrice: 10, orderId: "1" }),
        new ProductCheckoutModel({ id: "2", name: "second product", description: "second product description", salesPrice: 20, orderId: "1" }),
      ],
      status: "status 1",
      createdAt: new Date(),
      updatedAt: new Date(),
