...
describe("Place Order Use Case", () => {
    ...
    describe("validadeProducts method", () => {
        ...
        it("should throw an error when no products are selected", async () => {
            ...
            await expect(
                placeOrderUseCase["validateProducts"](input)).rejects.toThrow(new Error("No products selected")
                );
        });

        it("should throw an error wher product is out of stock", async () => {
            ...
            await expect(placeOrderUseCase["validateProducts"](input)).rejects.toThrow(
                new Error("Product 1 is not available")
            );
            ...
            await expect(
                placeOrderUseCase["validateProducts"](input)).rejects.toThrow(
                    new Error("Product 1 is not available")
                );
